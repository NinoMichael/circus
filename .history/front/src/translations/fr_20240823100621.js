const fr = {
    ...
    aboutHeaderTitle: "Bienvenue sur Circus, votre solution de réservation de transport régional conçue pour rendre vos déplacements plus simples, rapides et efficaces. Circus vous permet de planifier vos trajets en quelques clics, en toute tranquillité. L'application s'adapte à vos besoins en vous offrant un accès rapide à une large gamme de services de transport, vous garantissant ainsi une expérience de voyage fluide et agréable. Découvrez une nouvelle manière de voyager avec Circus, où chaque trajet est un pas vers plus de liberté.",
}
