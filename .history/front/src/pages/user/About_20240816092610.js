        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
             ...
             <main>
                ...
                <article className = "mt-16">
                    ...
                    <Button label = {t('seeAll')} className="flex justify-end items-end ml-auto me-20 mt-8 rounded px-4 py-2 font-poppins text-sm text-white bg-slate-900 border border-none outline outline-none"/>
                </article>
             </main>
        </motion.div>
    )
