...
const About = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
             ...
             <main>
                <article className="bg-amber-400 text-black flex justify-center space-x-12 py-8 px-12">
                    <div>
                    ...
                    <div>
                        <img src = {gare} alt = "Gare" width={200} height={200} className="rounded w-full h-48"/>
                    </div>
                </article>
             </main>
        </motion.div>
