        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                ...
                <article className="flex flex-row justify-center mt-24 mb-24 space-x-40 max-[900px]:space-x-16 max-md:flex-col max-md:items-center max-md:mx-auto">
                    ...
                    <div>
                        <img src={gare} alt="Réservation spéciale" width={300} height={300} className="w-96 h-80 rounded max-[900px]:h-52 max-[900px]:w-72 max-[900px]:mt-10 max-md:w-80 max-md:h-64 max-md:-ms-8 max-md:mt-4" />
                    </div>
                </article>
