...
const About = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                <article className="bg-amber-400 text-black flex justify-between py-8 px-44 max-[1170px]:px-28 max-[900px]:px-12">
                    <div className="mt-4">
                    ...
                    <div>
                        <img src={gare} alt="Gare" width={200} height={200} className="rounded w-80 h-64" />
                    </div>
                </article>
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center mt-8 mx-48 max-[1170px]:mx-24">
                ...
                <article className="flex flex-row justify-center mt-24 mb-24 space-x-40">
                    ...
                    <div>
                        <img src={gare} alt="Réservation spéciale" width={300} height={300} className="w-96 h-80 rounded" />
                    </div>
                </article>
