...
const About = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                <article className="bg-amber-400 text-black flex justify-between py-8 px-44 max-[1170px]:px-28">
                    <div className="mt-4">
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center mt-8 mx-48 max-[1170px]:mx-32">
