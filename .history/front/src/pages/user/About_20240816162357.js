            ...
            <main>
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center mt-8 mx-48">
                        <div className="ms-24">
                            <Carousel value={imgDatas} numVisible={1} numScroll={1} itemTemplate={ImgCarousel} showIndicators={false} showNavigators={false} circular autoplayInterval={3000} />
                        </div>

                        <div className="w-[140%] -ms-12">
