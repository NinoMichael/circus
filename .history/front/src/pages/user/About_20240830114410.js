...
const About = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                <article className="bg-amber-400 text-black flex justify-between py-8 px-44 max-[1170px]:px-28 max-[900px]:mt-8 max-[900px]:px-16">
                    <div className="mt-4">
                        <h1 className="font-kanit text-3xl">{t('aboutTitle')}</h1>
                        <p className="text-sm w-[40vw] mt-4">{t('aboutHeaderTitle')}</p>
                    </div>
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center mt-8 mx-48 max-[1170px]:mx-24 max-[900px]:mx-4">
                        ...
                        <div className="w-[140%] max-[900px]:-ms-12">
                ...
                <article className="flex flex-row justify-center mt-24 mb-24 space-x-40 max-[900px]:space-x-16">
                    <div className="-mt-6">
                        <h2 className="text-2xl font-kanit mt-4">{t('specialBookTitle')}</h2>
                        <p className="text-sm mt-6 w-80">{t('specialBookTxt')}</p>

                        <Link to=""><Button label={t('bookBus')} className="font-poppins text-sm bg-slate-900 text-white border border-none outline outline-none rounded mt-16 px-5 py-2" /></Link>
                    </div>

                    <div>
                        <img src={gare} alt="Réservation spéciale" width={300} height={300} className="w-96 h-80 rounded max-[900px]:h-52 max-[900px]:w-72 max-[900px]:mt-4" />
                    </div>
                </article>
