...
const About = () => {
    ...
    const ImgCarousel = (imgData) => {
        return (
            <>
                <img src={imgData.img} alt="Ville Madagascar" width={250} height={250} className="w-80 h-64 rounded max-[1170px]:w-72 max-[1170px]:h-52 max-[400px]:w-64 max-[400px]:h-44 max-[400px]:mx-auto" />
            </>
        )
    }
