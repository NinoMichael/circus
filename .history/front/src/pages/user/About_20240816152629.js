...
const About = () => {
    ...
    const ImgCarousel = (imgData) => {
        return (
            <>
                <img src={imgData.img} alt="Ville Madagascar" width={200} height={200} className="w-64 h-48 rounded" />
            </>
        )
    }
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                <article className="bg-amber-400 text-black flex justify-between py-8 px-44">
                    ...
                    <div>
                        <img src={gare} alt="Gare" width={300} height={300} className="rounded w-96 h-64" />
                    </div>
                </article>
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center">
                        <div>
                            <Carousel value={imgDatas} itemTemplate={ImgCarousel} showIndicators={false} showNavigators={false} />
                        </div>
