        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                ...
                <article className="mt-16 mx-24">
                    ...
                    <Button label={t('seeAll')} className="bg-slate-900 text-white border border-none outline outline-none font-poppins flex justify-center items-center mx-auto mt-12 mb-16 px-8 py-2 text-sm" />
                </article>
