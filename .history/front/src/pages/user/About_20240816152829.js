...
import rn2 from "../../images/assets/rn2.jpg"
...
const About = () => {
    ...
    const imgDatas = [
        { id: 1, img: rn2 }, { id: 2, img: isalo }, { id: 3, img: tana }
    ]
            ...
            <main>
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center">
                        <div>
                            <Carousel value={imgDatas} numVisible={1} numScroll={1} itemTemplate={ImgCarousel} showIndicators={false} showNavigators={false} />
                        </div>
