            ...
            <main>
                ...
                <article className="mt-16">
                    ...
                    <section className="flex justify-center mt-8 mx-48 max-[1170px]:mx-24 max-[900px]:mx-4 max-md:flex-col max-md:items-center max-md:mx-auto">
                        <div className="ms-20 mt-8 max-md:ms-40">
                        ...
                        <div className="w-[140%] max-[900px]:-ms-12 max-md:ms-0">
                            {missionsData.map((mission, index) => (
                                <div key={index} className="flex justify-start mb-6 max-md:mx-auto max-md:items-center max-md:justify-center ">
                                    <i className={`${mission.icon} me-3 mt-4 max-md:text-center`}></i>

                                    <div>
                                        <h5 className="font-semibold max-md:text-center">{mission.title}</h5>
                                        <p className="text-sm max-md:text-center">{mission.text}</p>
                                    </div>
