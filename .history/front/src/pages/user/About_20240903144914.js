...
const About = () => {
    ...
    const ImgCarousel = (imgData) => {
        return (
            <>
                <img src={imgData.img} alt="Ville Madagascar" width={250} height={250} className="w-80 h-64 rounded max-[1170px]:w-72 max-[1170px]:h-52 max-[400px]:w-64 max-[400px]:h-44 max-[400px]:ms-4" />
            </>
        )
    }
            ...
            <main>
                <article className="bg-amber-400 text-black flex justify-between py-8 px-44 max-[1170px]:px-28 max-[900px]:mt-8 max-[900px]:px-16 max-md:flex-col max-md:items-center max-md:mx-auto max-md:justify-center">
                    <div className="mt-4">
                        ...
                        <p className="text-sm w-[40vw] mt-4 max-md:text-center max-[500px]:w-[80vw]">{t('aboutHeaderTitle')}</p>
                    </div>
                ...
                <article className="mt-16">
                    ...
                    <p className="text-center text-sm mt-2 max-[500px]:mx-8">{t('missionP')}</p>
                    ...
                    <section className="flex justify-center mt-8 mx-48 max-[1170px]:mx-24 max-[900px]:mx-4 max-md:flex-col max-md:items-center max-md:mx-auto">
                        ...
                        <div className="w-[140%] max-[900px]:-ms-12 max-md:ms-0 max-[400px]:w-[80vw]">
                            {missionsData.map((mission, index) => (
                                <div key={index} className="flex justify-start mb-6 max-md:mx-auto max-md:items-center max-md:justify-center max-md:w-96 max-[400px]:w-80 max-md:mt-6">
                ...
                <article className="flex flex-row justify-center mt-24 mb-24 space-x-40 max-[900px]:space-x-16 max-md:flex-col max-md:items-center max-md:mx-auto max-[400px]:w-80">
                    <div className="-mt-6">
                        ...
                        <Link to=""><Button label={t('bookBus')} className="font-poppins text-sm bg-slate-900 text-white border border-none outline outline-none rounded mt-16 px-5 py-2 max-md:ms-5" /></Link>
                    </div>

                    <div>
                        <img src={gare} alt="Réservation spéciale" width={300} height={300} className="w-96 h-80 rounded max-[900px]:h-52 max-[900px]:w-72 max-[900px]:mt-10 max-md:w-80 max-md:h-64 max-md:me-24 max-md:mt-12 max-[400px]:w-52 max-[400px]:h-48" />
                    </div>
                </article>

                <article className="mt-16 max-[400px]:w-80 max-[400px]:mx-auto">
                    ...
                    <section className="grid grid-cols-4 max-md:grid-cols-2 max-md:gap-y-4 max-[500px]:grid-cols-1 mt-8 mx-20 max-[900px]:mx-6">
                        {
                    ...
                    <Button label={t('seeAll')} className="flex justify-end items-end ml-auto me-20 mt-8 rounded px-5 py-2 font-poppins text-sm text-white bg-slate-900 border border-none outline outline-none max-[400px]:mx-auto" />
                </article>

                <article className="mt-16 mx-24 max-md:mx-8">
                    <h2 className="font-kanit text-xl text-center">{t('faqTitle')}</h2>
                    <p className="text-center text-sm mt-2">Lorem ipsum dolor emet si dolor emet si dolor emet si</p>

                    <section className="flex justify-center space-x-6 mt-8 max-[500px]:flex-col max-[500px]:items-center max-[500px]:mx-auto">
                        <Accordion multiple className="w-[49vw] max-[500px]:w-[80vw] font-poppins text-black font-light text-sm">
                        ...
                        <Accordion multiple className="w-[49vw] max-[500px]:w-[80vw] max-[500px]:-ms-0 font-poppins text-black font-light text-sm">
