            ...
            <main>
                ...
                <article className="flex flex-row justify-center mt-24 mb-24 space-x-40 max-[900px]:space-x-16 max-md:flex-col max-md:items-center max-md:mx-auto">
                    <div className="-mt-6">
                        ...
                        <Link to=""><Button label={t('bookBus')} className="font-poppins text-sm bg-slate-900 text-white border border-none outline outline-none rounded mt-16 px-5 py-2 max-md:ms-4" /></Link>
                    </div>
