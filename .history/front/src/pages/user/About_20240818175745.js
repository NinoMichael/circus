            ...
            <main>
                ...
                <article className="flex flex-row justify-center mt-24 mb-24 space-x-32">
                    <div className="mt-10">
                        ...
                        <Link to=""><Button label={t('bookBus')} className="font-poppins text-sm bg-slate-900 text-white border border-none outline outline-none rounded mt-6 px-5 py-2" /></Link>
                    </div>
