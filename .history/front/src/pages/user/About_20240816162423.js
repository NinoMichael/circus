        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main>
                ...
                <article className="mt-16">
                    <h2 className="text-center font-kanit text-xl">{t('missionCircus')}</h2>
                    ...
                    <section className="flex justify-center mt-8 mx-48">
                        <div className="ms-24">
                            <Carousel value={imgDatas} numVisible={1} numScroll={1} itemTemplate={ImgCarousel} showIndicators={false} showNavigators={false} circular autoplayInterval={3000} className="w-full" />
                        </div>

                        <div className="w-[140%] -ms-36">
                            <div className="flex justify-start">
                                <i className="pi pi-car me-4 mt-2"></i>

                                <div>
                                    <h5 className="font-semibold">Lorem ipsum dolor emet si dolor emet si</h5>
                                    <p className="text-sm">Lorem ipsum dolor emet si dolor emet si</p>
                                </div>
                            </div>
                        </div>
                    </section>
