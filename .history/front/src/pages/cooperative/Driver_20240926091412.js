    ...
    const renderGridDriver = (driver, index) => {
        return (
            <div className="col-12 bg-white border shadow-sm rounded" key={index}>
                ...
                <Avatar imageAlt="Image" image={driver.imgBus1} size="xlarge" shape="circle" className="flex justify-center items-center mx-auto mt-8" />

                <div>
                    <p className="text-center font-poppins font-semibold text-sm mt-4">{driver.nom}</p>
                </div>
            </div>
        )
    }
