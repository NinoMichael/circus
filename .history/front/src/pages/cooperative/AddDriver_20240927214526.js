                    ...
                    <form className="bg-white shadow-lg rounded mx-24 pb-12 mt-6">
                        <section className="grid grid-cols-2 mt-8">
                            <div className="flex justify-center items-center m-auto relative">
                                ...
                                <FileUpload mode="basic" name="demo[]" accept="image/*" maxFileSize={1000000} customUpload auto uploadHandler={onUpload} chooseLabel="Upload Image" />
                                <i className="pi pi-plus-circle text-slate-900 font-extrabold text-3xl absolute bottom-0 right-2" onClick={() => document.querySelector('.p-fileupload-choose input').click()}></i>
                            </div>
