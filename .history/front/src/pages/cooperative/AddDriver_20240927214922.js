                    ...
                    <form className="bg-white shadow-lg rounded mx-24 pb-12 mt-6">
                        <section className="grid grid-cols-2 mt-8">
                            <div className="flex justify-center items-center m-auto relative">
                                ...
                                <i className="pi pi-plus-circle text-slate-900 font-extrabold text-3xl absolute bottom-0 right-24" onClick={() => document.querySelector('.p-fileupload-choose input').click()}></i>
                            </div>
