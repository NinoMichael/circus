                ...
                <main className="mt-3">
                    ...
                    <section className="grid grid-cols-2 mt-8">
                        <div>
                            ...
                            {imgTransport ? <div className="border border-black-300 w-64 mt-64 flex justify-center items-center">
                                {<img src={imgTransport} alt="Transport" />}
                            </div>
                                :
                                <div className="border border-dashed border-black py-20 px-12 w-64 mt-64 flex justify-center items-center">
