        ...
        return (
            <div className="col-12 bg-white border shadow-sm rounded" key={index}>
                ...
                <div className="flex justify-between">
                    <Link to = ""><Button className="bg-white border border-none outline outline-none" icon = "pi pi-check" /></Link>
                    <Link to = ""><Button className="bg-white border border-none outline outline-none" icon = "pi pi-trash" /></Link>
                </div>
            </div>
        );
    };
