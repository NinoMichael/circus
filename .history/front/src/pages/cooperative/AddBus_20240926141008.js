            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="ps-[16.25rem] -z-50">
                ...
                <main className="mt-3">
                    ...
                    <section className="grid grid-cols-[30%-70%] mt-8">
                        <div>
                            <div className="border-dashed border-black border-1 bg-white">
                                <p className="text-sm flex justify-center items-center m-auto"><i className="pi pi-plus me-2"></i>{t('addImage')}</p>
                            </div>
                        </div>
