                    ...
                    <section className="grid grid-cols-2 mt-8">
                        <div>
                            ...
                            <div className="border border-dashed border-black py-20 px-12 w-64 m-auto flex justify-center items-center">
                                <p className="border border-dashed text-sm flex justify-center items-center m-auto cursor-pointer" onClick={onUpload}><i className="pi pi-plus me-2"></i>{t('addImage')}</p>
                            </div>
                        </div>
