            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="ps-[16.25rem] -z-50">
                ...
                <main className="mt-3">
                    ...
                    <form>
                        ...
                        <Button label={t('validate')} className="py-2 px-8 text-black bg-amber-400 hover:bg-amber-500 border border-none outline outline-none flex justify-center items-center mx-auto mt-5" />
                    </form>
