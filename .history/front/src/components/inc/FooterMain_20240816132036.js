        ...
        <>
            <footer className="mt-16 bg-slate-900 text-white py-4 px-20">
                <div className="grid grid-cols-4">
                    ...
                    <section>
                        <h3 className="font-semibold text-sm mt-2">{t('quickLink')}</h3>
                        <Link to="/trip" className="text-xs"><p className="mt-3">FAQs</p></Link>
                        <Link to="/trip" className="text-xs"><p className="mt-3">{t('terms2Services')}</p></Link>
                        <Link to="/trip" className="text-xs"><p className="mt-2">{t('use2Conditions')}</p></Link>
                    </section>
