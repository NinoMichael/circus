...
const FooterMain = () => {
    ...
    return (
        <footer className="mt-16 bg-slate-900 text-white py-4 px-20 max-lg:px-6 max-md:mx-auto">
            <div className="grid grid-cols-4 max-md:grid-cols-2 max-md:gap-y-6">
                <section>
                    <img src={logo} alt="Logo Circus" width={100} height={100} className="w-20 h-20" />
                    <p className="text-xs w-52 max-lg:w-44">{t('platform')}</p>
                </section>
            ...
            <p className="text-[0.6em] mt-6 text-end -me-14 max-lg:-me-2">{t('copyright')}</p>
        </footer>
