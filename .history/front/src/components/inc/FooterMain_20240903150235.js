...
const FooterMain = () => {
    ...
    return (
        <footer className="mt-16 bg-slate-900 text-white py-4 px-20 max-lg:px-6">
            <div className="grid grid-cols-4 max-md:grid-cols-2 max-md:gap-y-6 max-md:ms-24 max-[550px]:ms-6">
                <section>
                    <img src={logo} alt="Logo Circus" width={100} height={100} className="w-20 h-20" />
                    <p className="text-xs w-52 max-lg:w-44 max-[460px]:w-52">{t('platform')}</p>
                </section>
