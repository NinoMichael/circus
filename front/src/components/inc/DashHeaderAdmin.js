        ...
        <header className="flex justify-between bg-white fixed shadow-sm w-[82vw] h-[10vh] -mt-3 pt-2 pb-12 ps-6 pe-10 z-50">
            ...
            <div className="flex ms-40">
                ...
                <Link className="flex space-x-3 ms-8 mt-1">
                    <Avatar label="A" size="large" shape="circle" className="bg-slate-900 text-white" />
                    <div className="mt-3">
                        <p className="text-sm font-kanit">Admin</p>
                    </div>
                </Link>
            </div>
...
export default DashHeaderAdmin