    ...
    return (
        <>
            <div className='max-xmd:hidden flex justify-between'>
                <Menubar model={menuItems} className='text-white font-poppins custom-main-menubar' start={logoContainer} end={authBtn} />
                {languageDropdown}
            </div>

            <div className='xmd:hidden max-sm:hidden flex justify-between mx-16 max-md:mx-8'>
                <div className="flex justify-start mt-3">
                    <Menubar model={menuItems} className='text-white font-poppins custom-main-menubar'/>
            ...
            <div className='sm:hidden flex justify-between mx-16 max-md:mx-8 max-xs:mx-4'>
                <div className="flex justify-start mt-3">
                    <Menubar model={menuItemsMobile} className='text-white font-poppins custom-main-menubar'/>
