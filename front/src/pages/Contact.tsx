...
const Contact = () => {
	...
	return (
		<>
			<SEO
				title="Contact"
				description="Contactez l'équipe Circus pour toutes vos questions sur la réservation de taxi-brousse à Madagascar. Support par téléphone, email ou directement depuis nos bureaux à Ivato."
				keywords="contact circus, support taxi-brousse, service client madagascar"
				url="/contact"
			/>
			<motion.div
				...
				<div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
					<div>
						...
						<p className="mb-8 leading-relaxed">
							Vous avez une question sur Circus ? Contactez notre équipe pour
							vos trajets régionaux.
						</p>
