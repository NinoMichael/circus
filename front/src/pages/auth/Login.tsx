...
const Login = () => {
	...
	return (
		<>
			<SEO
				title="Connexion"
				description="Connectez-vous à votre compte Circus pour gérer vos réservations de taxi-brousse et accéder à votre espace personnel."
				keywords="connexion circus, mon compte, espace utilisateur"
				url="/login"
			/>
			<motion.div
