...
const Register = () => {
    ...
    const handleChange = (field: string, value: string) => {
        ...
        if (isPasswordField) {
            ...
            const confirm = field === 'password_confirmation' ? value : form.password_confirmation;
    ...
    const inputClass = (hasError = false) =>
        `w-full rounded-lg border ${hasError ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-primary'} bg-white pl-10 pr-9 py-3 text-sm focus:outline-none focus:ring-2 focus:border-none duration-200 transition-all`;
        ...
        >
            <div className="w-full grid md:grid-cols-2 gap-8 items-center lg:mx-20">
                ...
                <div className="rounded-lg shadow-lg bg-white p-8">
                    ...
                    <p className="text-sm mb-6">Veuillez remplir les informations ci-dessous</p>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-300 bg-white pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-none duration-200 transition-all"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <motion.div variants={item} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                            <Button
                                ...
                                type="submit" disabled={passwordMismatch}
                            >
