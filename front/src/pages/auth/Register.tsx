...
const Register = () => {
	...
	return (
		<>
			<SEO
				title="Inscription"
				description="Créez votre compte Circus et réservez facilement vos voyages en taxi-brousse à Madagascar. Profitez d'un profil personnel pour gérer vos réservations."
				keywords="inscription circus, créer compte, s'inscrire"
				url="/register"
			/>
			<motion.div
