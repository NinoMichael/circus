	...
	return (
		<>
			<SEO
				...
				description="Complétez votre inscription sur Circus en renseignant vos informations personnelles. Rejoignez des milliers de voyageurs satisfaits."
				keywords="inscription, informations personnelles, compte utilisateur"
				url="/register/info"
			/>
			<motion.div
